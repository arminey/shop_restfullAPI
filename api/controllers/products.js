...
exports.products_create_order = (req, res, next) => {
...
exports.products_get_order = (req, res, next) => {
...
exports.products_update_order = (req, res, next) => {
    const id = req.params.productId;
    const updateOps = {};
    if(req.body.name) {
...
exports.products_delete_order = (req, res, next) => {
    const id = req.params.productId;
